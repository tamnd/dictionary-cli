...
Most of these come down to network reality or how dictionary serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dictionary rate-limits like any public site. dict already paces
...
Where a surface is gated, dict reads a cookie or token you supply
...
`dict`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dict actually did
